<div class="product-details-full {{#if model.item.custitem_sca_is_matrix}}matrix{{/if}}">
	...
	<article class="product-details-full-content" itemscope itemtype="https://schema.org/Product">
		...
		<section class="product-details-full-main-content">
			...
			<div data-cms-area="product_details_full_cms_area_5" data-cms-area-filters="path"></div>
		</section>
		...
		<div data-cms-area="product_details_full_cms_area_108" data-cms-area-filters="path" class="plp-cms"></div>
		<div class="product-details-full-content-related-items">
			<div data-view="Related.Items"></div>
		</div>
		<div data-cms-area="product_details_full_cms_area_109" data-cms-area-filters="path" class="plp-cms"></div>
		
		<div data-cms-area="product_details_full_cms_area_110" data-cms-area-filters="path" class="plp-cms"></div>
		<div data-cms-area="product_details_full_cms_area_111" data-cms-area-filters="path" class="plp-cms"></div>
